        ...
        ***********************************-->
        ...
        <!-- ************ -->
          ...
          <!-- add dashboard section -->
				...
				<!---- add contact ----->
				<div class="modal fade" id="addOrderModalside1">
							...
							<div class="modal-body">
								<form method="post" class="client_form">
									...
									<div class="form-group">
										<label class="text-black font-w500">Client Source</label>
										<select class="form-control" name=client_source  id="client_source">
									...
									<div class="form-group">
										<label class="text-black font-w500">Website</label>
	          ...
	          <!---- add update contact ----->
				...
				<div class="modal fade update_client" id="addOrderModalside1">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body  update_model">
								<form method="post" class="update_client_data">

									@csrf

								   <input type="hidden" class="form-control" name='client_id' id="update_client_id">
								     <input type="hidden" class="form-control" name='oldimage' id="update_oldimage">
									<div class="form-group">
										<label class="text-black font-w500">Client Source</label>
										<select class="form-control" name=client_source  id="update_client_source">
										     @foreach($client_source as $cs)
									...
									<div class="form-group">
										<label class="text-black font-w500">Client Name</label>
										<input type="text" class="form-control" name='client_name' id="update_client_name">
									...
									<div class="form-group">
										<button type="button" class="btn btn-primary create" id="update">Update</button>
				...
				<div class="d-flex flex-wrap mb-2 align-items-center justify-content-between">
					...
					<div class="d-flex mb-3">
						<a href="javascript:void(0)" class="btn btn-primary text-nowrap n_contact" data-toggle="modal" data-target="#addOrderModalside1">+ new client</a>
					</div>
				</div>
				<div class="co_contact">
					<div class="row client_list">

						@foreach($client_list as $c)
						<div class="col-xl-3 col-xxl-4 col-lg-4 col-md-6 col-sm-6 items client_{{$c->id}}">
                            <div class="card contact-bx item-content">
                                <div class="card-header border-0">
                                    <div class="action-dropdown">
                                        <div class="dropdown ">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" onclick="delete_client({{$c->id}})">Delete</a>
                                                <a class="dropdown-item" onclick="update_client_data({{$c->id}})">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body user-profile">
                                    ...
                                    <div class="media-body user-meta-info">
                                        <h6 class="fs-18 font-w600 my-1"><a href="app-profile.html" class="text-black user-name" data-name="Alan Green">{{$c->client_name}}</a></h6>
                                        <p class="fs-14 mb-3 user-work" data-occupation="UI Designer">{{$c->company_name}}</p>
                                        <ul>
                       	...
                       	<div class="modal-dialog modal-confirm">
                       		<div class="modal-content">
                       			...
                       			<div class="modal-footer justify-content-center">
                       				...
                       				<button type="button" class="btn btn-danger delete_client_data" id="client_id">Delete</button>
                       			</div>
                       		</div>
                       	</div>
                       </div>  
...
/*******************************  INSERT CLIENT ***********************************************************/
      ...
      $(document).ready(function() {
            ...
            $.ajax({
                url: BASE_URL+'/store_client_data',
                type:'POST',
                data: {_token:_token,email:email,name:name,client_source:client_source,company_name:company_name,mobile_no:mobile_no,website:website},
                success: function(data) {
                    ...
                    if($.isEmptyObject(data.error)){
                     ...
                     createAlert('','Success!','client data inserted successfully!!.','success',true,true,'pageMessages');
...
/*******************************  DELETE CLIENT***********************************************************/
        ...
        $('.delete_client_data').click(function(){
 ...
 /*******************************  UPDATE CLIENT***********************************************************/
               ...
               function update_client_data($id){
            	            ...
            	            $.ajax({
                                ...
                                //	alert(response.data.client_name);	
                                	  ...
                                	  $("#update_client_source").val(response.data.client_source);
                                	  $("#update_client_name").val(response.data.client_name);
                                	  $("#update_company_name").val(response.data.company_name);
                                	  $("#update_email").val(response.data.email);
                                	  $("#update_mobile_no").val(response.data.mobile_no);
                                	  $("#update_website").val(response.data.website);
                                	  $("#update_client_id").val(response.data.client_id);
        ...
        $("#update").click(function(e){
            ...
            var client_source = $('#update_client_source').val();
            ...
            $.ajax({
                url: BASE_URL+'/store_update_client_data/'+client_id,
                type:'POST',
                data: {_token:_token,email:email,name:name,client_source:client_source,company_name:company_name,mobile_no:mobile_no,website:website},
                success: function(data) {
                    ...
                    if($.isEmptyObject(data.error)){
                    	...
                    	if(data.status==201){
                          ...
                          $('.update_client').modal('hide');

                    	}else{

                        $( '.update_client_data' ).each(function(){
                         ...
                         $('.error-text').text('');
                          ...
                          $('.update_client').modal('hide');
                            ...
                            $('.client_'+client_id).html("");
                            $('.client_'+client_id).html(data);


                        //  $('#addOrderModalside1').hide();
   
                         createAlert('','Success!','client data updated successfully!!.','success',true,true,'pageMessages');
